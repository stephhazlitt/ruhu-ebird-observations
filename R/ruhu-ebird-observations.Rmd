...
And again, the plot confirms the original analysis&mdash;first observations are later and frequencies are lower for Rufous Hummingbirds, especially in Oregon, Washingtion and British Columbia.
...
## ADDENDUM: Sharing My Code Makes Me Both `r emo::ji("fearful")` & `r emo::ji("smiley")`

Using open source software and switching to 'coding' my data analyses is about two things for me&mdash;I believe in open science _and_ it takes me many, many tries before I get things just right, or what he said...

<img src = "../images/tabranch_tweet.png" width = "500"></img>

Now, actually _opening_ my own code makes me feel vulnerable `r emo::ji("fearful")`. What if the approach is wrong? What if my code is dreadful? I push past the nerves&mdash;mostly&mdash;and have found that the dialogue from being open makes the resulting work, and my code, much better. Even for this just-for-fun `r emo::ji("eyes")` look at Rufous Hummingbirds!

<img src = "../images/more_tweets.png" width = "500"></img>

So, final, final plots, with improved hummingbird image `r emo::ji("smile")`.
